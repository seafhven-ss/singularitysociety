      ...
      <main>
          ...
          <div className="mx-auto max-w-4xl px-6 pb-16 pt-28 sm:pb-20 sm:pt-36">
            ...
            <FadeInUp delay={0.2}>
              <p className="mt-6 max-w-2xl text-base leading-relaxed text-[var(--text-secondary)] sm:text-lg">
                产品合作、技术咨询、IP 授权、内容联创——有什么想法，直接聊。
              </p>
            </FadeInUp>
          </div>
        </section>
            ...
            <FadeInUp>
              <div className="rounded-xl border border-[var(--border-default)] bg-[var(--bg-panel)] p-6">
                <div className="flex items-center gap-3">
                  ...
                  <p className="text-sm font-medium text-white">邮件联系</p>
                </div>
                <p className="mt-3 text-sm text-[var(--text-tertiary)]">最直接的方式，通常 24 小时内回复</p>
                <a
            ...
            <FadeInUp delay={0.1}>
              <div className="rounded-xl border border-[var(--border-default)] bg-[var(--bg-panel)] p-6">
                <div className="flex items-center gap-3">
                  ...
                  <p className="text-sm font-medium text-white">办公地点</p>
                </div>
        ...
        <section className="py-16 sm:py-20">
          <div className="mx-auto max-w-4xl px-6">
            <FadeInUp>
              <p className="text-xs font-medium uppercase tracking-[0.28em] text-[var(--text-tertiary)]">Social</p>
              <h2 className="mt-4 text-2xl font-semibold tracking-tight text-white sm:text-3xl">其他渠道</h2>
            </FadeInUp>
