            ...
            <div className="grid gap-12 lg:grid-cols-[minmax(0,1fr)_420px] lg:items-center">
              <FadeInUp>
                <div>
                  ...
                  <h1 className="mt-6 max-w-[900px] text-[1.95rem] font-semibold leading-[1.12] tracking-normal text-white sm:text-[3.35rem] sm:leading-[1.08] lg:text-[4.05rem] lg:leading-[1.04]">
                    <span className="block whitespace-nowrap">客户开始问 AI</span>
                    <span className="block whitespace-nowrap">“哪家公司靠谱”时，</span>
                    <span className="block whitespace-nowrap">你的企业会出现吗？</span>
                  </h1>
